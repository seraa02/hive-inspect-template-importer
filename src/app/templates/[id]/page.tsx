    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {template.sections.map((section) => (
          <details key={section.id} className="border border-gray-200 rounded-xl bg-white shadow-sm group">
            ...
            <div className="border-t border-gray-100 px-4 py-3 space-y-3">
              {section.items.map((item) => (
                <details key={item.id} className="border border-gray-100 rounded-lg group/item">
