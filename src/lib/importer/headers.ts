// Header labels like "Category (-1: Low, 0: Med, 1: High)" carry a
// human-readable hint in parentheses that isn't part of the column's
// identity - strip it (and case/whitespace) before matching.
...
export const CANONICAL_COLUMNS = {
  ...
  // Listed explicitly rather than generated, to keep this a literal-typed object.
